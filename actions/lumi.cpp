...
QVariant ActionsLUMI::PetFeeder::request(const QString &name, const QVariant &data)
{
    quint32 command;
    QByteArray payload = QByteArray::fromHex("0002"), value;
    ...
    switch (m_actions.indexOf(name))
    {
        case 0: // feed
        {
            ...
            command = qToBigEndian <quint32> (0x04150055);
            value = QByteArray(1, 0x01);
            break;
        }

        case 1: // childLock
        {
            command = qToBigEndian <quint32> (0x04160055);
            value = QByteArray(1, static_cast <char> (data.toBool() ? 0x01 : 0x00));
            break;
        }

        case 2: // indicator
        {
            command = qToBigEndian <quint32> (0x04170055);
            value = QByteArray(1, static_cast <char> (data.toBool() ? 0x01 : 0x00));
            break;
        }
        ...
        case 3: // operationMode
        {
            ...
            command = qToBigEndian <quint32> (0x04180055);
            value = QByteArray(1, static_cast <char> (index));
            break;
        }
        ...
        case 4: // servingSize
        {
            ...
            command = qToBigEndian <quint32> (0x0E5C0055);
            value = QByteArray(reinterpret_cast <char*> (&size), sizeof(size));
            break;
        }
        ...
        case 5: // portionWeight
        {
            ...
            command = qToBigEndian <quint32> (0x0E5F0055);
            value = QByteArray(reinterpret_cast <char*> (&weight), sizeof(weight));
            break;
        }
    ...
    payload.append(reinterpret_cast <char*> (&command), sizeof(command));
    payload.append(static_cast <char> (value.length()));
