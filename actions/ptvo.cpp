...
QVariant ActionsPTVO::Status::request(const QString &, const QVariant &data)
{
    return zclHeader(FC_CLUSTER_SPECIFIC, m_transactionId++, data.toBool() ? 0x01 : 0x00);
}

QVariant ActionsPTVO::AnalogInput::request(const QString &, const QVariant &data)
{
...
QVariant ActionsPTVO::SerialData::request(const QString &, const QVariant &data)
{
